    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (id){
            ...
            case R.id.mHotel:
                ...
                break;
            case R.id.mHotel2:
                Intent intent22 = new Intent(HotelDActivity.this,Hotel2Activity.class);
                ...
                break;
            case R.id.mRest:
                Intent intent3 = new Intent(HotelDActivity.this,RestaurantDActivity.class);
                ...
                break;
            case R.id.mTuris:
                Intent intent4 = new Intent(HotelDActivity.this,TouristDActivity.class);
