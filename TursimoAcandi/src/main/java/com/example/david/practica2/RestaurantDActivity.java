...
public class RestaurantDActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (id){
            case R.id.main:
                Intent intent = new Intent(RestaurantDActivity.this,MainDActivity.class);
                ...
                break;
            case R.id.mHotel:
                Intent intent2 = new Intent(RestaurantDActivity.this,HotelDActivity.class);
                ...
                break;
            case R.id.mHotel2:
                Intent intent22 = new Intent(RestaurantDActivity.this,Hotel2Activity.class);
                ...
                break;
            case R.id.mRest:
                Intent intent3 = new Intent(RestaurantDActivity.this,RestaurantDActivity.class);
                ...
                break;
            case R.id.mTuris:
                Intent intent4 = new Intent(RestaurantDActivity.this,TouristDActivity.class);
                ...
                break;
            case R.id.mSignout:
                Intent intent5 = new Intent(RestaurantDActivity.this,LoginActivity.class);
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position){
                case 0: Restaurant1 tab1 = new Restaurant1();
                    return tab1;
                case 1: Restaurant2 tab2 = new Restaurant2();
                    return tab2;
                case 2: Restaurant3 tab3 = new Restaurant3();
                    return tab3;
                default: return null;
            }
        }
        ...
        public CharSequence getPageTitle(int position) {
            switch (position) {
                case 0:
                    return getString(R.string.rest1);
                case 1:
                    return getString(R.string.rest2);
                case 2:
                    return getString(R.string.rest3);
            }
            return null;
        }
    }
