    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id){
            case R.id.main:
                ...
                break;
            case R.id.mProfile:
                Intent intent2 = new Intent(RestaurantActivity.this,ProfileActivity.class);
                ...
                break;
            case R.id.mHotel:
                Intent intent3 = new Intent(RestaurantActivity.this,HotelActivity.class);
                ...
                break;
            case R.id.mTuris:
                Intent intent4 = new Intent(RestaurantActivity.this,TuristicActivity.class);
                ...
                break;
            case R.id.mSignout:
                Intent intent5 = new Intent(RestaurantActivity.this,LoginActivity.class);
