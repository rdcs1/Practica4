...
public class TuristicActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id){
            case R.id.main:
                Intent intent = new Intent(TuristicActivity.this,MainActivity.class);
                ...
                break;
            case R.id.mProfile:
                Intent intent2 = new Intent(TuristicActivity.this,ProfileActivity.class);
                ...
                break;
            case R.id.mHotel:
                Intent intent3 = new Intent(TuristicActivity.this,HotelActivity.class);
                ...
                break;
            case R.id.mRest:
                Intent intent4 = new Intent(TuristicActivity.this,RestaurantActivity.class);
                ...
                break;
            case R.id.mSignout:
                Intent intent5 = new Intent(TuristicActivity.this,LoginActivity.class);
